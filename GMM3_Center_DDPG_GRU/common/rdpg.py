...
class RDPG():
    def __init__(self, args, replay_buffer, state_space, action_space):
        ...
        self.qnet = QNetworkGRU(device_idx, state_space, action_space, self.hidden_1, self.hidden_2, self.hidden_3, args.n_layers, args.drop_prob).to(self.device)
        self.target_qnet = QNetworkGRU(device_idx, state_space, action_space, self.hidden_1, self.hidden_2, self.hidden_3, args.n_layers, args.drop_prob).to(self.device)
        self.policy_net = DPG_PolicyNetworkGRU(device_idx, state_space, action_space, self.hidden_1, self.hidden_2, self.hidden_3, args.n_layers, args.drop_prob).to(self.device)
        self.target_policy_net = DPG_PolicyNetworkGRU(device_idx, state_space, action_space, self.hidden_1, self.hidden_2, self.hidden_3, args.n_layers, args.drop_prob).to(self.device)
