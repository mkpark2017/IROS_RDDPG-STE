...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', default='gym_ste_v2:StePfGmmConvExtEnv-v0', type=str, help='open-ai gym environment')
    ...
    if args.mode == 'train':
        ...
        for i_episode in range (max_episodes):
            ...
            if evaluate is not None and (i_episode-validate_start)%args.validate_interval == 0 and update_bool:
                policy = lambda x: alg.policy_net.get_action(x, 0.)
                debug = True
                visualize = True
            ...
            for step in range(max_steps):
                ...
                if batch_length == args.blength:
                    batch_length = 0
                    replay_buffer.push(batch_state, batch_action, batch_last_action, \
