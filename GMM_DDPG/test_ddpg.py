...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', default='gym_ste_v2:StePfGmmConvExtMatEnv-v0', type=str, help='open-ai gym environment')
    ...
    parser.add_argument('--model_path', default='model/2022_02_09_low_noise_current/gym_ste_v2:StePfGmmConvExtEnv-v0-run1/', type=str, help='Output root')
    ...
    if args.mode == 'test':
        ...
        for episode in range(test_episodes):
            ...
            while not done:
                ...
                action = alg.policy_net.get_action(observation, noise_scale=0.0)  # no noise for testing
